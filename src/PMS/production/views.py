        ...
        try:
            ...
            if step.step_no == "0010":
                ...
                if wodata_pre_step.ctr_code == "YY05":
                    ...
                    pre_step_good_rows = Record.objects.filter(wo_no=step.wo_main.wo_no, good_qty__gt=0).order_by('-update_at')
                    if pre_step_good_rows:
                        pre_step_good_qty = pre_step_good_rows[0].good_qty
                    else:
                        pre_step_good_qty = 0
