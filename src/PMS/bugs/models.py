...
class Bug(models.Model):
    ...
    belong_to = models.ForeignKey('requests.Request', related_name='bug_super', on_delete=models.CASCADE, null=True)  # 上層
    ...
    create_by = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.DO_NOTHING, related_name='bug_create_at')
    update_at = models.DateTimeField(auto_now=True, null=True)
    update_by = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.DO_NOTHING, related_name='bug_update_at')
...
class Bug_attachment(models.Model):
    bug = models.ForeignKey('Bug', related_name='bug_files')
